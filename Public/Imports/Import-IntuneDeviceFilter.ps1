function Import-IntuneDeviceFilter {
    ...
    if ($RemoveExisting) {
        ...
        $filtersToDelete = Get-HydrationDeleteCandidates -Endpoint 'beta/deviceManagement/assignmentFilters' -KnownTemplateNames $knownTemplateNames -RequireTemplateMatch
        ...
        $results += Invoke-GraphBatchOperation -Items $filtersToDelete -Operation 'DELETE' -ResultType 'DeviceFilter'
