...
function Remove-AutoGeneratedProperties {
    <#
    .SYNOPSIS
        Removes auto-generated properties from a configuration object.
    
    .PARAMETER Config
        The configuration object to clean.
    
    .DESCRIPTION
        Removes properties that are auto-generated by Intune and should not be
        included when creating new configurations.
    #>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory = $true)]
    ...
    foreach ($Property in $PropertiesToRemove) {
        if ($Config.PSObject.Properties[$Property]) {
...
function Import-CompliancePolicy {
    ...
    try {
        ...
        $Config = Remove-AutoGeneratedProperties -Config $Config
