...
You have three options when importing the baseline:

### **IntuneManagement**
This is a recommended method, as it allows for an import of the entire baseline. 
...
The [Intune Hydration Kit](https://github.com/jorgeasaurus/IntuneHydrationKit) can also import the OpenIntuneBaseline. The Intune Hydration Kit is a PowerShell module that bootstraps Microsoft Intune tenants with boilerplate configurations. It automatically downloads the latest OpenIntuneBaseline policies and imports them alongside compliance policies, dynamic groups, and more, turning hours of manual configuration into a single command.
